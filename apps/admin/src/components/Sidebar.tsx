...
const bottomLinks = [{ to: '/health', label: 'Health', icon: HealthIcon }]

const externalLinks = [
  { href: 'https://sebprunier.github.io/sanson/', label: 'Documentation', icon: DocsIcon },
]
...
export function Sidebar() {
  return (
    <aside className="w-64 bg-primary-800 text-white flex flex-col min-h-screen">
      ...
      <div className="border-t border-primary-700 py-2">
        ...
        {externalLinks.map((link) => (
          <a
            ...
            className="flex items-center gap-3 px-5 py-2.5 text-sm text-primary-200 hover:bg-primary-700/50 hover:text-white transition-colors"
          >
            <link.icon />
            {link.label}
            <ExternalLinkIcon />
      ...
      <div className="px-5 py-4 text-xs text-primary-400 border-t border-primary-700">
        Sanson v0.1.0
      </div>
    </aside>
  )
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0L12 17.25 6.43 14.25m11.142 0-4.179 2.25m-6.963 0L2.25 16.5l9.75 5.25 9.75-5.25-4.179-2.25"
      />
    </svg>
  )
}
